...
class FooGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("fooapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
